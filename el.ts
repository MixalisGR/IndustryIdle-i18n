export const EL = {
    ...
    NotEnoughCash: "Δεν έχεις αρκετά χρήματα για αυτή την αναβάθμιση",
    NotEnoughSwissMoney: "Δεν έχεις αρκετά Swiss για αυτή την αναβάθμιση",
    ...
    OfflineEarning: "Κέρδη όσο το παιχνίδι είναι κλειστό",
    OfflineEarningDesc: "Offline Earning depends on your market cap and interest rate",
    PerMin: "%{amount}/min",
    OfflineEarningTime: "Χρόνος που αποκτάς κέρδη ενώ το παιχνίδι είναι κλειστό",
    OfflineEarningTimeDesc: "Αυτό είναι το ανώτοτατο όριο κερδών όσο το παιχνίδι είναι κλειστό",
    BuyPermit: "Αγορά Άδειας",
    NotEnoughBuildingPermit: "Δεν υπάρχουν αρκετές οικοδομικές άδειες. Αγόρασε περισσότερες για να χτίσεις περισσότερα κτίρια",
    MovingAverage: "Moving Average",
    MovingAverageDesc: "Show moving average of change of resources instead of real-time change",
    AllowZoom: "Ζουμ",
    AllowZoomDesc: "Ενεργοποίηση το ζουμ. Χρησιμοποίησε τη ροδέλα του mouse για να ζουμάρεις. Το ζουμ αυτή τη στιγμή είναι %{zoom}",
    ...
    WholesaleCenter: "Παραγγελίες",
    OrderFrom: "Παραγγελία Από %{name}",
    ExpireIn: "Λήγει σε",
    ...
    NextOrderIn: "Επόμενη παραγγελία σε",
    FillOrder: "Ολοκλήρωσε την παραγγελία",
    RejectOrder: "Ακύρωση",
    YouHave: "Έχεις %{amount}",
    ...
    OrderFilled: "Η παραγγελία από τον/την %{from} ολοκληρώθηκε με επιτυχία!",
    PolicyCenter: "Policy Center",
    NewOrder: "Μια καινούργια παραγγελία από τον/την %{from} μόλις έφρασε. Κοίτα στην καρτέλα παραγγελίες",
    Policies: "Policies",
    ...
    CitySize: "Map Size",
    GridType: "Grid Type",
    StartInThisCity: "Ξεκίνα στην πόλη %{city}",
    CityBonus: "Bonus Πόλης",
    ResourceTilePercentage: "Resource Tiles",
    MapSquareGrid: "Square",
    MapHexGrid: "Hex",
    Stockholm: "Στοκχόλμη",
    StockholmBonus:
        "<li>Δωρεάν ανεμογεννήτρια επιπέδου 4 x1</li><li>Δωρεάν Πετρελαιοπηγή επιπέδου 4 x1</li><li>Δωρεάν διυλιστήριο επιπέδου 2 x1</li><li>Τα εργοστάσια χαρτιού είναι ξεκλειδωμένα </li><li>Τα δάση έχουν διπλάσιες εξαγωγές</li>",
    Rotterdam: "Rotterdam",
    RotterdamBonus:
        "<li>Τα χαλυβουργία έχουν διπλάσια χωρητικότητα </li><li>Τα εργοστάσια ανοξείδωτου ατσαλιού έχουν διπλάσια χωρητικότητα </li><li>Δωρεάν μεταφορά σιδήρου</li><li>Η μεταφορά ασταλιού κοστίσει 50% λιγότερα καύσιμα</li><li>Ξεκίνημα με διπλάσια χωρητικότητα πώλησης </li><li>No tile modifiers</li>",
    Oslo: "Oslo",
    OsloBonus:
